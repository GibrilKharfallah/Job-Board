...
const ProfileCompany = () => {
    ...
    const userId = storedUser?.user?.id; // Si pas de token, utilise l'ID depuis la route
    ...
    // Appel pour récupérer les infos de la compagnie
    const fetchCompanyInfo = () => {
        axios
            .get(`http://localhost:5000/company/get-company/${userId}`, {
